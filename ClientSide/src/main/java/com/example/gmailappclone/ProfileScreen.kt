...
fun ProfileScreen(
    ...
    Box(
        ...
        ModalNavigationDrawer(
            ...
            drawerContent = {
                DrawerItemUiLayout { labelName -> onLabelClicked(labelName) }
            },
            ...
            Scaffold(
                ...
                LazyColumn(
                    ...
                    items(mailList, key = { it.id }) { mailItem ->
                        ...
                        if (dismissState.currentValue == SwipeToDismissBoxValue.StartToEnd) {
                            LaunchedEffect(Unit) {
                                profileScreenViewModel.deleteMail(mailItem)
                            }
                        }
                    }
                }
